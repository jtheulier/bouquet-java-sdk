 ...
 *
 */
public class ClientSSOConfigurationLegacy extends Base {
	...
	/**
	 **/
	public ClientSSOConfigurationLegacy userAction(UserAction userAction) {
	...
	/**
	 **/
	public ClientSSOConfigurationLegacy ssoClass(String ssoClass) {
	...
	/**
	 **/
	public ClientSSOConfigurationLegacy ssoEndpoint(String ssoEndpoint) {
	...
	/**
	 **/
	public ClientSSOConfigurationLegacy ssoLoginPage(String ssoLoginPage) {
	...
	/**
	 **/
	public ClientSSOConfigurationLegacy clientId(String clientId) {
	...
	/**
	 **/
	public ClientSSOConfigurationLegacy clientSecret(String clientSecret) {
	...
	/**
	 **/
	public ClientSSOConfigurationLegacy redirectEndpoint(String redirectEndpoint) {
	...
	/**
	 **/
	public ClientSSOConfigurationLegacy samlConfiguration(String  samlConfiguration) {
	...
	/**
	 **/
	public ClientSSOConfigurationLegacy defaultAccessControlGroup(String defaultAccessControlGroup) {
