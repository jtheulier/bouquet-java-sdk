 ...
 *
 */
public class DatabaseProductFacade implements Serializable {
	 ...
	 * default constructor
	 */
	public DatabaseProductFacade() {
	}

	/**
	 * default constructor
	 */
	public DatabaseProductFacade(String productName) {
		this.productName = productName;
	}

	public DatabaseProductFacade(DatabaseProductFacade databaseProduct) {
