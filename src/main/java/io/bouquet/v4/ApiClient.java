...
import io.bouquet.v4.auth.HttpBasicAuth;
import io.bouquet.v4.auth.JWTAuth;
...
public class ApiClient {
	 ...
	 *
	 * @param basePath
	 *            Base path of the URL (e.g https://localhost/staging/v4.2
	 ...
	 * @return JSON object
	 */
	public JsonFactory getGsonFactory() {
		return json;
	}
	 ...
	 * @return Api client
	 */
	public ApiClient getGsonFactory(JsonFactory json) {
		this.json = json;
		return this;
	}
	...
	/**
	 * Helper method to set Client key for login basic loging/pwd
	 * authentication.
	 *
	 * @param apiKey
	 *            API key
	...
	public <T> T deserialize(Response response, Type returnType) throws ApiException {
		...
		if (isJsonMime(contentType)) {
			...
			throw new ApiException(response.code(), "Content type \"" + contentType + "\" is not supported for type: " + returnType);
		}
	}
