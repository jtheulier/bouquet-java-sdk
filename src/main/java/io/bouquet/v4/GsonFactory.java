...
import com.squid.kraken.v4.model.ClientOAuthEmbeddedConfiguration;
import com.squid.kraken.v4.model.ClientSSOConfiguration;
import com.squid.kraken.v4.model.ClientSSOCustomConfiguration;
import com.squid.kraken.v4.model.ClientSSOOAuthConfiguration;
import com.squid.kraken.v4.model.ClientSSOOpenIdConfiguration;
import com.squid.kraken.v4.model.ClientSSOSAMLConfiguration;
...
public class GsonFactory implements JsonFactory {
  ...
  public GsonFactory(ApiClient apiClient) {
    ...
    JsonDeserializer<ClientSSOConfiguration> clientSSOConfigurationDeserializer =
        new JsonDeserializer<ClientSSOConfiguration>() {
          @Override
          public ClientSSOConfiguration deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
              throws JsonParseException {
            if (json.isJsonObject()) {
              JsonObject jsonObject = json.getAsJsonObject();
              if (jsonObject != null) {
                if ("Custom".equals(jsonObject.get("type").getAsString())) {
                  return gson.fromJson(jsonObject, ClientSSOCustomConfiguration.class);
                } else if ("Embedded".equals(jsonObject.get("type").getAsString())) {
                  return gson.fromJson(jsonObject, ClientOAuthEmbeddedConfiguration.class);
                } else if ("OpenId".equals(jsonObject.get("type").getAsString())) {
                  return gson.fromJson(jsonObject, ClientSSOOpenIdConfiguration.class);
                } else if ("SAML".equals(jsonObject.get("type").getAsString())) {
                  return gson.fromJson(jsonObject, ClientSSOSAMLConfiguration.class);
                } else if ("OAuth".equals(jsonObject.get("type").getAsString())) {
                  return gson.fromJson(jsonObject, ClientSSOOAuthConfiguration.class);
                } else {
                  // throw new ApiException("Invalid facet type");
                  return null;
                }
    ...
    JsonSerializer<ClientSSOConfiguration> clientSSOConfigurationSerializer =
        new JsonSerializer<ClientSSOConfiguration>() {

          @Override
          public JsonElement serialize(ClientSSOConfiguration src, Type typeOfSrc, JsonSerializationContext context) {
            if (src instanceof ClientSSOCustomConfiguration) {
              return context.serialize(src, ClientSSOCustomConfiguration.class);
            } else if (src instanceof ClientOAuthEmbeddedConfiguration) {
              return context.serialize(src, ClientOAuthEmbeddedConfiguration.class);
            } else if (src instanceof ClientSSOOpenIdConfiguration) {
              return context.serialize(src, ClientSSOOpenIdConfiguration.class);
            } else if (src instanceof ClientSSOSAMLConfiguration) {
              return context.serialize(src, ClientSSOSAMLConfiguration.class);
            } else if (src instanceof ClientSSOOAuthConfiguration) {
              return context.serialize(src, ClientSSOOAuthConfiguration.class);
            } else {
              return null;
            }
          }
    ...
    gson = new GsonBuilder().registerTypeAdapter(Date.class, new DateAdapter(apiClient))
        ...
        .registerTypeAdapter(ClientSSOConfiguration.class, clientSSOConfigurationDeserializer)
        .registerTypeAdapter(ClientSSOConfiguration.class, clientSSOConfigurationSerializer)
        ...
        .registerTypeAdapter(ChosenMetric.class, credentialsSerializer).registerTypeAdapter(Col.class, colSerializer)
        .create();
  }
