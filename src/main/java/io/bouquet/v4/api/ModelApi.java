...
public class ModelApi extends BaseApi {
	...
	/**
	 * JSONP specific method which supports both get operation and set operation
	 * using GET
	 *
	 * @param projectId
	 * @param jobId
	...
	/**
	 * Creates an Attribute, if attribute's oid is set, it will be created under
	 * this id
	 *
	 * @param projectId
	 * @param domainId
	...
	/**
	 * Creates an DimensionOption, if attribute's oid is set, it will be created
	 * under this id
	 *
	 * @param projectId
	 * @param domainId
	...
	/**
	 * Token Validation. Tokens received via OAuth 2.0 Client-Side flow must be
	...
	/**
	 * Start the reset-password process. Create a new &#39;reset_pwd&#39;
	 * AccessToken for the user having the passed email address.
	 *
	 * @param customerId
	 * @param clientId
	 * @param email
