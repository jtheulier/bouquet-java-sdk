...
public class ModelApi extends BaseApi {
	...
	public InputStream postAndGetResultsAsFile(String projectId, String jobId, String ext, Integer timeout,
		...
		if (projectId == null) {
			throw new ApiException(400,
					"Missing the required parameter 'projectId' when calling postAndGetResultsAsFile");
		}
	...
	public Object getAnalysisJobResults(String projectId, String jobId, Integer timeout, Integer maxResults,
		...
		if (projectId == null) {
			throw new ApiException(400,
					"Missing the required parameter 'projectId' when calling getAnalysisJobResults");
		}
		...
		if (format == null) {
			localVarReturnType = new TypeToken<DataTable>() {
			}.getType();
		} else {
	...
	public List<DimensionOption> getDimensionOptions(String projectId, String domainId, String dimensionId)
		...
		if (dimensionId == null) {
			throw new ApiException(400,
					"Missing the required parameter 'dimensionId' when calling getDimensionOptions");
		}
	...
	public DimensionOption updateDimensionOption(DimensionOption body) throws ApiException {
		...
		if (body.getId().getProjectId() == null) {
			throw new ApiException(400,
					"Missing the required parameter 'projectId' when calling updateDimensionOption");
		}
		...
		if (body.getId().getDimensionId() == null) {
			throw new ApiException(400,
					"Missing the required parameter 'dimensionId' when calling updateDimensionOption");
		}
	...
	public Boolean deleteDimensionOption(String projectId, String domainId, String dimensionId, String optionId)
		...
		if (projectId == null) {
			throw new ApiException(400,
					"Missing the required parameter 'projectId' when calling deleteDimensionOption");
		}
		...
		if (dimensionId == null) {
			throw new ApiException(400,
					"Missing the required parameter 'dimensionId' when calling deleteDimensionOption");
		}
	...
	public List<Relation> getRelations(String projectId, String domainId) throws ApiException {
		...
		if (projectId == null) {
			throw new ApiException(400,
					"Missing the required parameter 'projectId' when calling getAllRelationsFromDomain");
		}

		// verify the required parameter 'domainId' is set
		if (domainId == null) {
			throw new ApiException(400,
					"Missing the required parameter 'domainId' when calling getAllRelationsFromDomain");
		}
	...
	public Relation getNewRelation(String projectId, String domainId) throws ApiException {
		...
		if (projectId == null) {
			throw new ApiException(400,
					"Missing the required parameter 'projectId' when calling setNewRelationInDomain");
		}

		// verify the required parameter 'domainId' is set
		if (domainId == null) {
			throw new ApiException(400,
					"Missing the required parameter 'domainId' when calling setNewRelationInDomain");
		}
	...
	public List<Relation> getRelations(String projectId) throws ApiException {
		...
		if (projectId == null) {
			throw new ApiException(400,
					"Missing the required parameter 'projectId' when calling getAllRelationsFromProject");
		}
	...
	public ExpressionSuggestion getRelationSuggestion(String projectId, String leftDomainId, String rightDomainId,
		...
		if (projectId == null) {
			throw new ApiException(400,
					"Missing the required parameter 'projectId' when calling getRelationSuggestion");
		}
	...
	public Boolean validateProjectConnection(String projectId) throws ApiException {
		...
		if (projectId == null) {
			throw new ApiException(400,
					"Missing the required parameter 'projectId' when calling validateProjectConnection");
		}
	...
	public List<AccessRight> getAccessRightFromState(String stateId) throws ApiException {
		...
		if (stateId == null) {
			throw new ApiException(400,
					"Missing the required parameter 'stateId' when calling getAccessRightFromState");
		}
