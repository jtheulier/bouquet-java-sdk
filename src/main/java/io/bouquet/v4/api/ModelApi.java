...
/**
 * Main client API class, provides all end points to manage clients, user & groups & projects Handle authentication
 * through JWT token. To get a JWT private key, you have to generate a new Client. With this JWT private key you can
 * connect to OpenBouquet server to request an access token for a given user
 *
 * @author jtheulier
 *
 */
...
public class ModelApi extends BaseApi {
  ...
  public ModelApi(ApiClient apiClient, String accessToken) throws ApiException {
    super(apiClient, accessToken);
  }
   ...
   */
  public DatabaseInfo getDatabaseStatus(String projectId, final ProgressResponseBody.ProgressListener progressListener,
  ...
  public ApiKey updateApiKey(ApiKey body) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/rs/apikeys/{apiKeyId}".replaceAll("\\{format\\}", "json")
        .replaceAll("\\{" + "apiKeyId" + "\\}", getApiClient().escapeString(body.getId().getApiKeyId().toString()));
  ...
  public Client updateClient(Client body) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/rs/clients/{clientId}".replaceAll("\\{format\\}", "json")
        .replaceAll("\\{" + "clientId" + "\\}", getApiClient().escapeString(body.getId().getClientId().toString()));
   ...
   * @throws ApiException if fails to make API call
   */
  public ExpressionSuggestion validateProjectConnection(String url, String username, String password, String projectId)
      throws ApiException {
    Object localVarPostBody = null;
  ...
  public Project updateProject(Project body) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/rs/projects/{projectId}".replaceAll("\\{format\\}", "json")
        .replaceAll("\\{" + "projectId" + "\\}", getApiClient().escapeString(body.getId().getProjectId().toString()));
  ...
  public ProjectAnalysisJob putAnalysisJob(String projectId, ProjectAnalysisJob body, Integer timeout,
      Integer maxResults, Integer startIndex, Boolean lazy, String format, String compression) throws ApiException {
    Object localVarPostBody = body;
   ...
   * @param jobId
   * @param ext
   * @param timeout response timeout in milliseconds in case the job is not yet computed. If no timeout set, the method
   *        will return according to current job status.
   * @param maxResults paging size
   * @param startIndex paging start index
   * @param lazy if true, get the analysis only if algety in cache
   ...
   * @param projectId
   * @param jobId
   * @param prettyfier if true return the SQL code as a html page and apply a prettyfier (default to true)
   * @throws ApiException if fails to make API call
   */
  ...
  public CacheInfo releaseDomainCache(String projectId, String domainId, RefreshCacheType refresh) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/rs/projects/{projectId}/domains/{domainId}/cache/refresh".replaceAll("\\{format\\}", "json")
        .replaceAll("\\{" + "projectId" + "\\}", getApiClient().escapeString(projectId.toString()))
        .replaceAll("\\{" + "domainId" + "\\}", getApiClient().escapeString(domainId.toString()));
  ...
  public List<Dimension> getDimensions(String projectId, String domainId) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/rs/projects/{projectId}/domains/{domainId}/dimensions".replaceAll("\\{format\\}", "json")
        .replaceAll("\\{" + "projectId" + "\\}", getApiClient().escapeString(projectId.toString()))
        .replaceAll("\\{" + "domainId" + "\\}", getApiClient().escapeString(domainId.toString()));
  ...
  public Dimension getDimension(String projectId, String domainId, String dimensionId, Boolean deepread)
    ...
    // create path and map variables
    String localVarPath =
        "/rs/projects/{projectId}/domains/{domainId}/dimensions/{dimensionId}".replaceAll("\\{format\\}", "json")
            .replaceAll("\\{" + "projectId" + "\\}", getApiClient().escapeString(projectId.toString()))
            .replaceAll("\\{" + "domainId" + "\\}", getApiClient().escapeString(domainId.toString()))
  ...
  public Attribute getAttribute(String projectId, String domainId, String dimensionId, String attributeId)
    ...
    // create path and map variables
    String localVarPath =
        "/rs/projects/{projectId}/domains/{domainId}/dimensions/{dimensionId}/attributes/{attributeId}"
            .replaceAll("\\{format\\}", "json")
            .replaceAll("\\{" + "projectId" + "\\}", getApiClient().escapeString(projectId.toString()))
            .replaceAll("\\{" + "domainId" + "\\}", getApiClient().escapeString(domainId.toString()))
            .replaceAll("\\{" + "dimensionId" + "\\}", getApiClient().escapeString(dimensionId.toString()))
   ...
   * @throws ApiException if fails to make API call
   */
  public DimensionOption setDimensionOption(String projectId, String domainId, String dimensionId, DimensionOption body)
      throws ApiException {
    Object localVarPostBody = body;
  ...
  public Metric getMetric(String projectId, String domainId, String metricId, Boolean deepread) throws ApiException {
    ...
    // create path and map variables
    String localVarPath =
        "/rs/projects/{projectId}/domains/{domainId}/metrics/{metricId}".replaceAll("\\{format\\}", "json")
            .replaceAll("\\{" + "projectId" + "\\}", getApiClient().escapeString(projectId.toString()))
            .replaceAll("\\{" + "domainId" + "\\}", getApiClient().escapeString(domainId.toString()))
  ...
  public Metric updateMetric(Metric body) throws ApiException {
    ...
    String localVarPath = "/rs/projects/{projectId}/domains/{domainId}/metrics/{metricId}"
        ...
        .replaceAll("\\{" + "projectId" + "\\}", getApiClient().escapeString(body.getId().getProjectId().toString()))
        .replaceAll("\\{" + "domainId" + "\\}", getApiClient().escapeString(body.getId().getDomainId().toString()))
        .replaceAll("\\{" + "metricId" + "\\}", getApiClient().escapeString(body.getId().getMetricId().toString()));
  ...
  public Relation getNewRelation(String projectId, String domainId) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/rs/projects/{projectId}/domains/{domainId}/relations/new".replaceAll("\\{format\\}", "json")
        .replaceAll("\\{" + "projectId" + "\\}", getApiClient().escapeString(projectId.toString()))
        .replaceAll("\\{" + "domainId" + "\\}", getApiClient().escapeString(domainId.toString()));
  ...
  public Facet getFacet(String projectId, String jobId, String facetId, String filter, Integer timeout,
    ...
    // create path and map variables
    String localVarPath =
        "/rs/projects/{projectId}/facetjobs/{jobId}/results/{facetId}".replaceAll("\\{format\\}", "json")
            .replaceAll("\\{" + "projectId" + "\\}", getApiClient().escapeString(projectId.toString()))
            .replaceAll("\\{" + "jobId" + "\\}", getApiClient().escapeString(jobId.toString()))
  ...
  /**
   * refresh database table metadata cache, usefull when a new column is added, to avoid to release the full project
   * (see releaseAllCaches)
   *
   * @param projectId
   ...
   * @throws ApiException if fails to make API call
   */
  public AccessToken authToken(String grantType, String code, String refreshToken, String clientId, String clientSecret,
  ...
  public Boolean deleteToken(String tokenId) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/rs/token/{tokenId}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "tokenId" + "\\}",
  ...
  public User getUser(String userId) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/rs/users/{userId}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "userId" + "\\}",
  ...
  public User updateUser(User body) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/rs/users/{userId}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "userId" + "\\}",
        getApiClient().escapeString(body.getId().getUserId().toString()));
  ...
  /**
   * Start the reset-password process. Create a new &#39;reset_pwd&#39; AccessToken for the user having the passed email
   * address.
   *
   * @param customerId
   * @param clientId
   ...
   * @param lang
   * @param linkUrl the link url base used to build the link enclosed in the email (ie.
   *        http://api.squisolutions.com/release/api/reset_email?access_token={access_token}). The url must match the
   *        Client authorized urls
   * @return String
   * @throws ApiException if fails to make API call
   */
  ...
  public MyBookmarkSelection getMyBookmarkSelection(String projectId, String bookmarkId, String MyBookmarkSelectionId,
    ...
    // verify the required parameter 'projectId' is set
    if (projectId == null) {
      throw new ApiException(400, "Missing the required parameter 'projectId' when calling getMyBookmarkSelection");
    }
    ...
    // create path and map variables
    String localVarPath =
        "/rs/projects/{projectId}/MyBookmarkSelections/{MyBookmarkSelectionId}".replaceAll("\\{format\\}", "json")
            .replaceAll("\\{" + "projectId" + "\\}", getApiClient().escapeString(projectId.toString())).replaceAll(
                "\\{" + "MyBookmarkSelectionId" + "\\}", getApiClient().escapeString(MyBookmarkSelectionId.toString()));
    ...
    Type localVarReturnType = new TypeToken<MyBookmarkSelection>() {}.getType();

    Call call = getApiClient().buildCall(localVarPath, "GET", localVarQueryParams, localVarPostBody,
        localVarHeaderParams, localVarFormParams, localVarAuthNames, null);
    ApiResponse<MyBookmarkSelection> resp = getApiClient().execute(call, localVarReturnType);
    return resp.getData();
   ...
   *
   * @param body the MyBookmarkSelection to update
   * @return MyBookmarkSelection
   * @throws ApiException if fails to make API call
   */
  public MyBookmarkSelection updateMyBookmarkSelection(MyBookmarkSelection body) throws ApiException {
    return getApiClient().callApi(ApiClient.Method.PUT, body.getId().getApiUri(false), body);
  }
  ...
  public List<MyBookmarkSelection> getMyBookmarkSelections(String projectId, String bookmarkId) throws ApiException {
    ...
    // verify the required parameter 'projectId' is set
    if (projectId == null) {
      throw new ApiException(400, "Missing the required parameter 'projectId' when calling getMyBookmarkSelections");
    }

    // create path and map variables
    String localVarPath =
        "/rs/projects/{projectId}/bookmarks/{bookmarkId}/myselections".replaceAll("\\{format\\}", "json")
            .replaceAll("\\{" + "projectId" + "\\}", getApiClient().escapeString(projectId.toString()))
            .replaceAll("\\{" + "bookmarkId" + "\\}", getApiClient().escapeString(bookmarkId.toString()));
    ...
    Map<String, Object> localVarFormParams = new HashMap<String, Object>();
    String[] localVarAuthNames = new String[] {"kraken_auth"};
    Type localVarReturnType = new TypeToken<List<MyBookmarkSelection>>() {}.getType();

    Call call = getApiClient().buildCall(localVarPath, "GET", localVarQueryParams, localVarPostBody,
        localVarHeaderParams, localVarFormParams, localVarAuthNames, null);
    ApiResponse<List<MyBookmarkSelection>> resp = getApiClient().execute(call, localVarReturnType);
    return resp.getData();

  }

  /**
   * Creates a MyBookmarkSelection, if MyBookmarkSelection's oid is set, it will be created under this id
   *
   * @param projectId
   * @param MyBookmarkSelectionId
   * @param body
