...
public class ClientEngine {
	...
	private static final Map<String, Object> summaryKpisOptions = new HashMap<String , Object>() {
		private static final long serialVersionUID = -8598427823208916262L;
		{
		...
		public ProjectAnalysisJob buildAnalysisFromBookmark(ModelApi api, Bookmark bookmark, boolean isSummary, ComparePeriod defaultComparePeriod) throws ApiException, InterruptedException {
			...
			if (bookmark != null) {
...

				{
					...
					analysis.setOptionKeys(summaryKpisOptions);
				} else
