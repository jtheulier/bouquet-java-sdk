...
public class JWTConfiguration implements Serializable {
   ...
   */
  public JWTConfiguration(@JsonProperty("basePath") String basePath, @JsonProperty("clientId") String clientId,
      @JsonProperty("privateKey") String privateKey, @JsonProperty("userId") String userId,
