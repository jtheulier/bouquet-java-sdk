...
public class CacheConfiguration implements Serializable {
  ...
  public CacheConfiguration(@JsonProperty("refreshType") String refreshType, @JsonProperty("clearFlag") String clearFlag, @JsonProperty("comparePeriodDefault") String defaultComparePeriod,
