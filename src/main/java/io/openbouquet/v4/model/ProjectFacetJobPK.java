...
public class ProjectFacetJobPK extends ProjectPK  {
	...
	private String facetJobId = null;


	/**
	 **/
	public ProjectFacetJobPK facetJobId(String facetJobId) {
		this.facetJobId = facetJobId;
		return this;
	}

	@ApiModelProperty(example = "null", value = "")
	@JsonProperty("facetJobId")
	public String getFacetJobId() {
		return facetJobId;
	}
	public void setFacetJobId(String facetJobId) {
		this.facetJobId = facetJobId;
	}
