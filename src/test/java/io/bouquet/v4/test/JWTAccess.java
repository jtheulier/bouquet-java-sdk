 ...
 * This JWT allows to log using any user on Bouquet. Such access should be kept for specific cases such as complex batch
 * integrations, SSO
 * 
 * @author jtheulier
 */
public class JWTAccess {
  ...
  public static void main(String[] args) {
    try {
      JWTConfiguration.fromJson(args[0]);
